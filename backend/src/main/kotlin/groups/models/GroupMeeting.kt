 ...
 */
suspend fun createGroupMeeting(userId: String, meeting: SubmittedGroupMeeting): GroupMeeting {
    val groupMeeting =
        GroupMeeting(
 ...
 */
suspend fun updateMeeting(meetingId: String, meeting: SubmittedGroupMeeting) = query {
