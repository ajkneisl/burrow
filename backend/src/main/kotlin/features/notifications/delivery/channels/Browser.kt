...
import app.burrow.features.notifications.delivery.deletePushSubscription
import app.burrow.features.notifications.delivery.getUserPushSubscriptions
        ...
        try {
            ...
            subscriptions.forEach { subscription ->
                try {
                    ...
                    val notification =
                        Notification(webPushSubscription, payloadJson)
