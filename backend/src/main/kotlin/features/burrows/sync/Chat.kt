...
class Chat(burrowID: String) : Block("CHAT", burrowID) {
    ...
    @Serializable
    data class ChatMember(val userID: String, val username: String, val name: String)
    ...
    /** @see wsDeleteMessage */
    @Serializable
    data class DeletedMessage(@Serializable(with = UUIDSerializer::class) val messageID: UUID)
