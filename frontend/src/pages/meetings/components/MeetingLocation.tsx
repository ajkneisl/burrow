...
export default function MeetingLocation({ location }: MeetingLocationProps) {
    ...
    return (
        <section className="border border-primary/30 rounded-2xl bg-card/80 shadow-sm">
            <div className="p-4">
                <h3 className="mb-2 text-sm font-semibold text-maroon-800">
                    Location
                </h3>
            ...
            {hit && (
                <iframe
                    title="map"
                    className="w-full h-64 border-t border-primary/20 rounded-b-2xl"
